...
export const CompanionForm = ({
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            if(initialData){
                //endpoint to update companion functionality
                await axios.patch(`/api/companion/${initialData.id}`, values)
            } else {
                //endpoint to create companion 
            ...
            //this is going to refresh all server components, and show the latest companion
            router.refresh()
            router.push("/")
        } catch (error) {
            toast({
                    ...
                    <FormField
                            ...
                            render={({field}) =>(
                                <FormItem className="col-span-2 md:col-span-1">
                                    ...
                                    <FormDescription>
                                        Describe your companion&apos;s details and back story
                                    </FormDescription>
                                    <FormMessage/>
                                </FormItem>
                            )}
